...
export const SAMPLE_ORDERS: Order[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        productName: 'JSW Neo Steel Bars',
  ...
  },
  {
    ...
    price: 4075,
    unit: 'Pieces',
    imageSearch: 'red bricks construction',
    badge: null,
    isBulkDiscount: false,
    items: [
      {
    ...
    materials: [
      {
        id: 'm1',
        name: 'Red Bricks',
        description: '500 Pieces · Class A ISI',
        imageSearch: 'red bricks construction',
        productId: 'bricks_red',
        cartLineId: 'bricks_red_rb_500',
        quantityLabel: '500 Pieces',
        unitPriceLabel: '₹4,075',
        total: 4075,
        gstRate: 18,
        gstAmount: 734,
      },
    ...
    deliveredEarly: true,
    paymentMethod: 'upi',
    paymentMethodLabel: 'Pay with UPI',
    deliveryETA: 'Delivered',
    arrivingBy: 'Delivered',
    warehouse: 'Thane West Hub Warehouse',
    statusLabel: 'DELIVERED',
    quantitySummary: '500 Pieces Red Bricks',
    productGrade: 'Class A ISI',
  },
  {
    id: 'BJW-88200',
    status: 'delivered',
    ...
    deliveredEarly: false,
    refundAmount: 339,
    paymentMethod: 'cash_on_delhivery',
    paymentMethodLabel: 'Cash on Delhivery',
    deliveryETA: 'Delivered',
    arrivingBy: 'Delivered',
    warehouse: 'Thane West Hub Warehouse',
    statusLabel: 'DELIVERED',
