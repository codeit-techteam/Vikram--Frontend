...
const IMAGE_BY_QUERY: Record<string, ImageSourcePropType> = {
  ...
  'red bricks a+': images.productRedBricksAPlus,
  'red bricks b+': images.productRedBricksBPlus,
  'grey flash cement bricks construction': images.productGreyFlashCementBricks,
  'fly ash bricks a+': images.productGreyAshBricksAPlus,
  'fly ash bricks b+': images.productGreyAshBricksBPlus,
  'grey ash bricks a+': images.productGreyAshBricksAPlus,
  'grey ash bricks b+': images.productGreyAshBricksBPlus,
