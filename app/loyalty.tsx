  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={['top']}>
      ...
      <View className="mx-5 mt-6 rounded-card bg-primary p-6">
        <Text className="text-sm font-bold text-text-inverse">{t('platinumContractor')}</Text>
        <Text className="mt-2 text-3xl font-bold text-text-inverse">12,450 pts</Text>
        <Text className="mt-2 text-sm text-text-inverse/80">{t('redeemPointsNextOrder')}</Text>
      </View>
    </SafeAreaView>
  );
}
