  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={['top']}>
      <View className="mb-4 flex-row items-center gap-3 px-5 py-4">
        ...
        <Text className="text-xl font-bold text-primary">{t('bulkProcurement')}</Text>
      </View>
      <View className="mx-5 rounded-card bg-primary p-6">
        ...
        <Text className="mt-3 text-sm leading-5 text-text-inverse/90">{t('bulkProcurementSubtitle')}</Text>
